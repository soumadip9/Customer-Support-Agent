...
| Predictions | `results/hybrid_golden_predictions.jsonl` |
...
| Escalation accuracy | **0.9500** (95.0%) |
| Escalation precision (ESCALATE) | 0.9262 |
| Escalation recall (ESCALATE) | 0.9912 |
| Escalation F1 (ESCALATE) | 0.9576 |
| Combined accuracy (intent + esc both correct) | **0.9150** (91.5%) |
