...
| Predictions | `results/hybrid_v2_golden_predictions.jsonl` |
...
| Escalation accuracy | **0.9750** (97.5%) |
| Escalation precision (ESCALATE) | 0.9658 |
| Escalation recall (ESCALATE) | 0.9912 |
| Escalation F1 (ESCALATE) | 0.9784 |
| Combined accuracy (intent + esc both correct) | **0.9300** (93.0%) |
